...
```{r}
data <- read_dta("input/data/original/zhp_anchor_bv1_0.dta")
...
```{r}
load("processing/objects/rp.Rdata")
...
# replace
data_cohes <- data_patterns %>% dplyr::select(pid, pcohes01:pcohes12,careless)
...
```{r}
save(data_cohes, file="input/data/proc/data_cohes.Rdata")
```
